  ...
  return (
    <div>
      ...
      <Modal isOpen={formModal} toggle={() => setFormModal(!formModal)} className='modal-dialog-centered'>
        <ModalHeader toggle={() => setFormModal(!formModal)}>Credit {customerDetails.firstName}'s Wallet</ModalHeader>
        <Formik
          initialValues={{
            amount: '',
            narration: '',
          ...
          onSubmit={async (values, { setSubmitting }) => {
            ...
            await dispatch(getCustomerDetails(customerDetails.id))
          }}
        >
...
export const DeductFunds = ({ customerDetails }) => {
  ...
  return (
    <div>
      ...
      <Modal isOpen={formModal} toggle={() => setFormModal(!formModal)} className='modal-dialog-centered'>
        <ModalHeader toggle={() => setFormModal(!formModal)}>Debit {customerDetails.firstName}'s Wallet</ModalHeader>
        <Formik
          initialValues={{
            amount: '',
            narration: '',
